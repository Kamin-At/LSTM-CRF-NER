...
print(device)
data_tr = MyDataloader('clean_small_tr2.txt', 'label_small_tr2.txt',\
...
for BS in [16, 64, 256]:
  tr, te = get_indices_random_val_test_split(len(data_tr), 1, 0.3, True)
  ...
  #                               True, tags, i, pos_size, FCN)
          ...
          break
      break
  with open('log_word_retest_gpu_BS_' +str(BS)+'_max_size_char_'+str(max_size_char)+'.txt', 'w', encoding='utf8') as f:
    f.write('exp1, exp2, exp3\n')
